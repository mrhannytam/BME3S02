...
def worker():
    def Eyes(check):
         ...
         if check == 'True':
             channel1.play(pygame.mixer.Sound('/home/pi/Desktop/Doll_Therapy/media/sound2/success.wav'))
             draw.text((43, 0), 'O',  font=led_font, fill=255) #Draw 'O' on OLED monitor
             blink(image)         
            
         elif check == 'False':
             channel1.play(pygame.mixer.Sound('/home/pi/Desktop/Doll_Therapy/media/sound2/fail.wav'))
...
font = pygame.font.Font('/home/pi/Desktop/Doll_Therapy/media/font/mnjzbh.ttf', 30)
    ...
    while True:
        for e in pygame.event.get(): #this part is for game event, something like a receiver
            if e.type == PLAYSOUNDEVENT and not pygame.mixer.music.get_busy():
                ...
                #pygame.mixer.music.load("/home/pi/Desktop/Doll_Therapy/media/sound/opening/opening1.mp3")
...
def game_end():
    ...
    while True:
        ...
        if SCORE > 10: #Show different label to the elderly according to their score
            TEXT = "十分好!!!"
            COLOR = BRIGHT_GREEN
            #pygame.mixer.music.load('/home/pi/Desktop/Doll_Therapy/media/sound/vgood.mp3')
            #pygame.mixer.music.play()
            
        elif SCORE > 5:
            TEXT = "做得好!"
            COLOR = GREEN
            #pygame.mixer.music.load('/home/pi/Desktop/Doll_Therapy/media/sound/good.mp3')
            #pygame.mixer.music.play()
            ...
            TEXT = "再接再勵~"
            COLOR = RED
            #pygame.mixer.music.load('/home/pi/Desktop/Doll_Therapy/media/sound/again.mp3')
            #pygame.mixer.music.play()
