...
font = pygame.font.Font('./media/font/mnjzbh.ttf', 62)
...
def game_loop(difficult = None):
    ...
    while True:
        ...
        #correct
        button("正確", 140, 0, 140, 65, RED, BRIGHT_RED, correct_ans_test)
...
def correct_ans_test():
    global SCORE
    print('correct')
    SCORE += 1 #Add score
    pass_ans() #Change question
    Eyes2(True)
...
#def end_game_sound(SCORE):
    ...
    if SCORE > 10: #Show different label to the elderly according to their score
        TEXT = "十分好!!!"
        #pygame.mixer.music.load('./media/sound/vgood.mp3')
        #pygame.mixer.music.play()
        COLOR = BRIGHT_GREEN

    elif SCORE > 5:
        TEXT = "做得好!"
        #pygame.mixer.music.load('./media/sound/good.mp3')
        #pygame.mixer.music.play()
        COLOR = GREEN
